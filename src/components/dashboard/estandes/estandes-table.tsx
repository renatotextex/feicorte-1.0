...
export function EstandesTable({
    count = 0,
    rows = [],
    onEdit,
    onDelete,
  }: EstandesTableProps): React.JSX.Element {
              ...
              <TableRow hover key={row.id}>
                ...
                <TableCell>
                  <Stack sx={{ alignItems: 'center' }} direction="row" spacing={2}>
                    <Typography variant="subtitle2">{row.identificacao}</Typography>
                  </Stack>
                </TableCell>
